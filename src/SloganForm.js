...
export default function SloganForm({ citySlogans, setCitySlogans }) {
  ...
  const [slogansForm, setSlogansForm] = useState('');
  ...
  return (
    <section>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input required value={slogansForm} onChange={handleFormChange}/>
